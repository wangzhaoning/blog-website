...
public class UserController {
	 ...
	 */
	@GetMapping("/edit/{id}")
	public ModelAndView editGetUserInfo(@PathVariable(value="id") Integer id,Model model){
	 ...
	 */
	@DeleteMapping("/{id}")
	public Response deleteUser(@PathVariable(value="id") Integer id,Model model){
